...
?>
		...
		<table class="table table-hover table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="update_page_admin.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Update</td>
					<td><a href="delete_page_admin.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</td>
				</tr>
		...
		<?php
			...
			if(isset($_GET['insert_msg'])){
			    echo '<h5>'.htmlspecialchars($_GET['insert_msg']).'</h6>'; // sanitized output
			}

			if(isset($_GET['update_msg'])){
				echo "<h5>".htmlspecialchars($_GET['update_msg'])."</h6>";
			}
