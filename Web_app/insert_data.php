...
if(isset($_POST['add_student'])){
    ...
    if (empty($fname) && empty($lname) && empty($age)) {
        header('location:home.php?message=You need to fill the first name, Last name and Age!');
        exit;
    }

    if (empty($fname)) {
        header('location:home.php?message=You need to fill the first name!');
        exit;
    }

    if (empty($lname)) {
        header('location:home.php?message=You need to fill the last name!');
        exit;
    }

    if (empty($age)) {
        header('location:home.php?message=You need to fill the age!');
        exit;
    }
